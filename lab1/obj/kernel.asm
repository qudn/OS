...
debuginfo_eip(uintptr_t addr, struct eipdebuginfo *info) {
  ...
  100562:	c7 45 f0 7c bb 10 00 	movl   $0x10bb7c,-0x10(%ebp)
    stabstr = __STABSTR_BEGIN__;
  100569:	c7 45 ec 7d bb 10 00 	movl   $0x10bb7d,-0x14(%ebp)
    stabstr_end = __STABSTR_END__;
  100570:	c7 45 e8 ef e4 10 00 	movl   $0x10e4ef,-0x18(%ebp)
...
read_ebp(void) {
  ...
  1009c2:	c7 04 24 c8 36 10 00 	movl   $0x1036c8,(%esp)
  ...
  1009f5:	c7 04 24 e4 36 10 00 	movl   $0x1036e4,(%esp)
  ...
  100a08:	7e d6                	jle    1009e0 <print_stackframe+0x51>
        ...
        cprintf("\n");
  100a0a:	c7 04 24 ec 36 10 00 	movl   $0x1036ec,(%esp)
...
parse(char *buf, char **argv) {
  ...
  100a7f:	c7 04 24 70 37 10 00 	movl   $0x103770,(%esp)
  ...
  100aa6:	00 
  100aa7:	c7 04 24 75 37 10 00 	movl   $0x103775,(%esp)
  ...
  100ae9:	c7 04 24 70 37 10 00 	movl   $0x103770,(%esp)
...
runcmd(char *buf, struct trapframe *tf) {
  ...
  100ba6:	c7 04 24 93 37 10 00 	movl   $0x103793,(%esp)
...
kmonitor(struct trapframe *tf) {
  ...
  100bc4:	c7 04 24 ac 37 10 00 	movl   $0x1037ac,(%esp)
  100bcb:	e8 50 f7 ff ff       	call   100320 <cprintf>
    cprintf("Type 'help' for a list of commands.\n");
  100bd0:	c7 04 24 d4 37 10 00 	movl   $0x1037d4,(%esp)
  ...
  100bed:	c7 04 24 f9 37 10 00 	movl   $0x1037f9,(%esp)
...
mon_help(int argc, char **argv, struct trapframe *tf) {
  ...
  100c5d:	c7 04 24 fd 37 10 00 	movl   $0x1037fd,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  100cd2:	c7 04 24 06 38 10 00 	movl   $0x103806,(%esp)
  ...
  100ceb:	e8 fb f5 ff ff       	call   1002eb <vcprintf>
    cprintf("\n");
  100cf0:	c7 04 24 22 38 10 00 	movl   $0x103822,(%esp)
  100cf7:	e8 24 f6 ff ff       	call   100320 <cprintf>
    
    cprintf("stack trackback:\n");
  100cfc:	c7 04 24 24 38 10 00 	movl   $0x103824,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  100d3d:	c7 04 24 36 38 10 00 	movl   $0x103836,(%esp)
  ...
  100d56:	e8 90 f5 ff ff       	call   1002eb <vcprintf>
    cprintf("\n");
  100d5b:	c7 04 24 22 38 10 00 	movl   $0x103822,(%esp)
...
clock_init(void) {
  ...
  100dc2:	c7 04 24 54 38 10 00 	movl   $0x103854,(%esp)
...
kbd_proc_data(void) {
  ...
  10157a:	75 1f                	jne    10159b <kbd_proc_data+0x180>
        cprintf("Rebooting!\n");
  10157c:	c7 04 24 6f 38 10 00 	movl   $0x10386f,(%esp)
...
cons_init(void) {
  ...
  1015f3:	c7 04 24 7b 38 10 00 	movl   $0x10387b,(%esp)
...
trap_dispatch(struct trapframe *tf) {
  ...
  101dca:	00 
  101dcb:	c7 44 24 04 af 00 00 	movl   $0xaf,0x4(%esp)
  101dd2:	00 
  ...
  101dff:	00 
  101e00:	c7 44 24 04 b9 00 00 	movl   $0xb9,0x4(%esp)
  101e07:	00 
